  ...
  return publicKey ? (
    <div className="animate-fadeIn">
      <AppHero
        ...
        subtitle={'Discover clients registered on the ChainHire platform and explore their projects.'}
      >
      ...
      <div className="text-center animate-fadeIn">
        <div className="glass-card p-12 max-w-md mx-auto">
          ...
          <p className="text-[var(--ch-text-muted)] mb-6">
            Connect your Solana wallet to view registered clients and their projects.
          </p>
          <WalletButton />
        </div>
      </div>
